...
<p float="left">
  <img src="docs/media/main/rover-v1-COTS-wheels.jpg" width="300" />
  <img src="docs/media/main/rover-v1-3D-printed-wheels.jpg" width="300" />
</p>
...
| Component               | Material / Design                       | Features                                                                               | Fabrication                                         |
| ----------------------- | --------------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------- |
| Chassis                 | High-quality acrylic held with L clamps | Durable and visually appealing design                                                  | Procured from Local Acrylic Laser Cutting Vendor    |
| Main Framework          | 20×20 mm aluminum extrusions            | Lightweight yet robust; maintains structural integrity while keeping weight manageable | Cut in campus workshop                              |
| Freely Moving Joints    | Flanged ball bearings                   | Reduces friction and wear; allows smooth, efficient movement                           | Procured online                                     |
| Side Bogie Stability    | Carbon fiber rods                       | High strength-to-weight ratio; reinforcement without added weight                      | Procured locally                                    |
| Wheels                  | Durable COTF material (10 cm × 4 cm)    | Ensures stability and smooth navigation across various terrains                        | Procured online                                     |
| Chassis Base            | 5 mm MDF board                          | Adds strength and stability; reliable support for components                           | Procured from Local MDF Board Laser Cutting Vendor  |
| Side Bogie Construction | Mild steel                              | High strength and resistance to bending; improves slope-climbing capability            | Procured from Local Mild Steel Laser Cutting Vendor |
